...
namespace MyFirstDatabaseCodeFirstMVC.Controllers
{
    public class SemestersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KodeSemester,NamaSemester,TahunAjaran")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KodeSemester,NamaSemester,TahunAjaran")] Semester semester)
        {
            if (ModelState.IsValid)
            {
